...
class Page extends Model
{
     ...
     */
    protected $fillable = [
        'title', 'slug','banner_title_en','banner_title_ar','banner_description_en','banner_description_ar','banner_image', 'image', 'description','investment_description_ar','who_we_are_en','our_mission_en','our_mission_ar','our_vision_en','our_vision_ar', 'meta_description','meta_description_ar','category_id', 'article_type_id',  'status', 'deleted_at', 'created_by', 'updated_by', 'deleted_by'
    ];
